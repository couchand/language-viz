...
(function() {
  var AllStars, CategoryStars, DescriptionGraph, LambdaStars, LanguageGraph, LanguageGraphMatrix, SelectableStar, describeGraph, hisDotsAndStars, hisStars, myStar, myStars,
  ...
  LanguageGraph = (function() {
    ...
    LanguageGraph.prototype.moveTo = function() {
      var t;
      t = this;
      return function(d) {
    ...
    LanguageGraph.prototype.centerStar = function() {
      ...
      t = this;
      return function(d) {
        return t.moveTo()(t.averages[d.lang]);
      };
    };
  ...
  LanguageGraphMatrix = (function(_super) {
    ...
    function LanguageGraphMatrix(w, h) {
      ...
      this.languagesByY = d3.nest().key(this.y()).sortKeys(function(a, b) {
  ...
  DescriptionGraph = (function(_super) {

    __extends(DescriptionGraph, _super);

    function DescriptionGraph(w, h) {
      if (w == null) {
        w = 200;
      }
      if (h == null) {
      ...
      DescriptionGraph.__super__.constructor.call(this, w, h);
    }

    DescriptionGraph.prototype.createCanvas = function() {
    ...
    DescriptionGraph.prototype.drawWords = function(focus) {
      this.word(focus, "Ideal", "ideal", 10, this.height + 25);
      this.word(focus, "System", "system", 20, 50);
      this.word(focus, "Script", "script", this.width - 10, this.height);
      this.word(focus, "Obselete", "obselete", this.width - 25, 40);
      this.word(focus, "slowness", "axes", this.width + 10, this.height + 35);
      return this.word(focus, "code size", "axes", 40, 70).attr("transform", "rotate(-90 40,70)");
    };

    DescriptionGraph.prototype.word = function(focus, w, c, x, y) {
      return focus.append("text").attr("x", x).attr("y", y).classed(c, function() {
        return true;
      }).text(w);
    };

    DescriptionGraph.prototype.draw = function(data) {
      var focus;
      this.initialize(data);
      focus = this.createCanvas();
      this.drawDots(focus);
      return this.drawWords(d3.select(this.container).select("svg"));
    };
  ...
  SelectableStar = (function(_super) {
    ...
    SelectableStar.prototype.languages = function() {
      var a, ls;
      ls = (function() {
        var _results;
        _results = [];
    ...
    SelectableStar.prototype.drawList = function() {
      var t;
      t = this;
      return d3.select(this.container).append("ul").selectAll("li").data(this.languages()).enter().append("li").text(function(d) {
        return d;
  ...
  AllStars = (function(_super) {

    __extends(AllStars, _super);

    function AllStars(w, h) {
      if (w == null) {
        w = 100;
      }
      if (h == null) {
    ...
    AllStars.prototype.render = function(focus) {
      this.drawDots(focus);
      return AllStars.__super__.render.call(this, focus);
    };
  ...
  LambdaStars = (function(_super) {

    __extends(LambdaStars, _super);

    function LambdaStars() {
      return LambdaStars.__super__.constructor.apply(this, arguments);
    }

    LambdaStars.prototype.type = function(d) {
      return lambdas[d.lang];
    };

    LambdaStars.prototype.drawBackground = function(focus) {
      return this.rect(focus).attr("class", this.type);
    };

    LambdaStars.prototype.render = function(focus) {
      this.drawBackground(focus);
      return LambdaStars.__super__.render.call(this, focus);
    };
  ...
  CategoryStars = (function(_super) {
    ...
    CategoryStars.prototype.type = function(d) {
      return types[d.lang];
    };
