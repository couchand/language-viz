...
(function() {
  var CategoryStars, average, background, best, byLanguage, flatten, getX, getX0, getY, getY0, languagesByX, languagesByXThenY, languagesByY, matrixValues, myStars, rect, rollup, setX, setY, type;
  ...
  getX = function(d) {
    return d[myStars.x_column];
  };

  getY = function(d) {
    return d[myStars.y_column];
  };
  ...
  getX0 = function(d) {
    return myStars.scaleX(getX(d));
  };

  getY0 = function(d) {
    return myStars.scaleY(getY(d));
  };
