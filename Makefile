...
www/languages.js: src/graph.coffee src/matrix.coffee src/select.coffee src/allstars.coffee src/lambda.coffee src/categories.coffee src/all.coffee
	coffee -c -o www -j languages src/graph.coffee src/matrix.coffee src/select.coffee src/allstars.coffee src/lambda.coffee src/categories.coffee src/all.coffee
